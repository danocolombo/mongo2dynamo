...
def gen_file_name(file_number):
    temp = './json_files/aws-ready-files/humans/aws-clients-file' + str(file_number) + '.json'
    return temp
...
def create_json_compliant_files():
    ...
    # file to read
    input_directory = "./json_files/mongo-export-files/humans/"
    input_file_name = "mongo-humans.json"
    input_file = f"{input_directory}{input_file_name}"
    # directory location for output files
    output_directory = "./json_files/aws-ready-files/humans"
